...
export enum AppSystemProp {
    ...
    PROMPTX_OPENAI_KEY = 'PROMPTX_OPENAI_KEY',
    PROMPTX_ANTHROPIC_KEY = 'PROMPTX_ANTHROPIC_KEY',
    PROMPTX_GOOGLE_KEY = 'PROMPTX_GOOGLE_KEY',
    CLOUD_PLATFORM_ID = 'CLOUD_PLATFORM_ID',
    CLOUD_TEMPLATES_SOURCE_URL = 'CLOUD_TEMPLATES_SOURCE_URL',
}
